...
Installed On Your System, Use The "Ctrl+`" Shortcut to open the terminal on Windows, In The Terminal Install The Following Packages Using These Commands: 1. ```npm i express```, 2. ```npm i fs```, 3. ```npm i cors``` and 4. ```npm i axios```.
